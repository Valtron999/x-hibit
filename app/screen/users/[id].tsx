...
export default function ProfileScreen() {
  ...
  /* =========================
     🔥 USER POSTS — real Supabase data now, not the mock postsData array
  ========================= */
  const {
    posts: userPosts,
  ...
  // Refetch whenever this screen regains focus — e.g. coming back here right
  // after publishing a new post from CreatePostScreen via Route.back()
  useFocusEffect(
    useCallback(() => {
      refetchPosts();
    }, [refetchPosts])
