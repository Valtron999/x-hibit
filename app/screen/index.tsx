    ...
    return(
        <SafeAreaView style={{ flex: 1, backgroundColor: "#030303" }}>
            ...
            <View style={{flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingHorizontal: 20, paddingBottom: 10, marginTop: 20, marginBottom: 20, borderBottomWidth: 1, borderBottomColor: "#A6A1A5"}}>
                ...
                <TouchableOpacity onPress={()=>Route.push("/screen/users/profile")} style={{ width: 30, height: 30, backgroundColor: "#ffffff", borderRadius: 30, alignSelf: "center", marginTop: 10, }}>
                            <Text style={{ fontSize: 16, fontWeight: "bold", color: "#BDBFC1", alignSelf: "center", marginTop: 5 }}>JD</Text>
                </TouchableOpacity>
            </View>
            <View>
                <CategoryTabs
